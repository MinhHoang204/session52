...
import Bai1_About from './About'
import Bai1_Blog from './Blog'
import Bai1_Contact from './Contact'
import Bai1_Repair from './Repair'
export default function Bai6() {
  ...
  <Routes>
    <Route path="/about" element={<Bai1_About></Bai1_About>}></Route>
    <Route path="/blog" element={<Bai1_Blog></Bai1_Blog>}></Route>
    <Route path="/contact" element={<Bai1_Contact></Bai1_Contact>}></Route>
    <Route path="/about" element={<Bai1_Repair></Bai1_Repair>}></Route>
  </Routes>
</>
